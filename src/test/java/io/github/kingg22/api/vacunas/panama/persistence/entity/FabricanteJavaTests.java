...
class FabricanteJavaTests {
    ...
    void mapToDtoSuccessful() {
        ...
        assertEquals(fabricante.getDireccion().getCreatedAt(), dto.getDireccion().createdAt());
        assertEquals(fabricante.getDireccion().getUpdatedAt(), dto.getDireccion().updatedAt());
        assertNotNull(dto.getDireccion().distrito());
        assertEquals(fabricante.getDireccion().getDistrito().getId(), dto.getDireccion().distrito().id());
        assertEquals(fabricante.getDireccion().getDistrito().getNombre(), dto.getDireccion().distrito().nombre());
        assertNotNull(dto.getDireccion().distrito().provincia());
        assertEquals(fabricante.getDireccion().getDistrito().getProvincia().getId(), dto.getDireccion().distrito().provincia().id());
        assertEquals(fabricante.getDireccion().getDistrito().getProvincia().getNombre(), dto.getDireccion().distrito().provincia().nombre());
    }
}
