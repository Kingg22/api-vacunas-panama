...
data class VacunaDto @JvmOverloads constructor(
    ...
    @JsonProperty(value = "edad_minima_dias") val edadMinimaDias: Short,
    @JsonProperty(value = "intervalo_dosis_dias") val intervaloDosisDias: Float,
    @JsonProperty(value = "dosis_maxima") val dosisMaxima: NumDosisEnum,
