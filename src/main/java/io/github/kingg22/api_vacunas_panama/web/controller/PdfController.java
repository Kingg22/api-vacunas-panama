...
import io.github.kingg22.api_vacunas_panama.service.PdfService;
...
public class PdfController {
    ...
    public ResponseEntity<byte[]> getPdfFile(@RequestParam("idPaciente") UUID idPaciente,
        ...
        try {
            ...
            headers.add(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=certificado_vacunas_".concat(idCertificado.toString()).concat(".pdf"));
