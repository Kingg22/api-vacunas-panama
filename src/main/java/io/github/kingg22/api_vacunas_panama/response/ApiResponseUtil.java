...
public class ApiResponseUtil {
     ...
     */
    public static void setMetadata(@NotNull IApiResponse<?, Serializable> apiResponse, ServletWebRequest servletWebRequest) {
     ...
     */
    public static ResponseEntity<IApiResponse<String, Serializable>> sendResponse(IApiResponse<String, Serializable> apiResponse, ServletWebRequest webRequest) {
     ...
     */
    public static IApiResponse<String, Serializable> transformApiErrorResponse(@NotNull ApiErrorResponse apiErrorResponse, Object request) {
