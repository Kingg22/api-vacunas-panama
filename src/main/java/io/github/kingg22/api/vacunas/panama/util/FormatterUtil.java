...
public class FormatterUtil {
    private static final Pattern INCORRECT_PATTERN =
            Pattern.compile("^(PE|E|N|[23456789](?:AV|PI)?|1[0123]?(?:AV|PI)?)-(\\d{1,4})-(\\d{1,6})$");
    private static final Pattern CORRECT_PATTERN =
            Pattern.compile("^(PE|E|N|[23456789](?:AV|PI)?|1[0123]?(?:AV|PI)?)-(\\d{4})-(\\d{6})$");
    private static final Pattern INCORRECT_PATTERN_RI = Pattern.compile(
            "^(RN(\\d{1,2}?)?)-(PE|E|N|[23456789](?:AV|PI)?|1[0123]?(?:AV|PI)?)-(\\d{1,4})-(\\d{1,6})$");
    private static final Pattern CORRECT_PATTERN_RI =
            Pattern.compile("^(RN(\\d{1,2}?)?)-(PE|E|N|[23456789](?:AV|PI)?|1[0123]?(?:AV|PI)?)-(\\d{4})-(\\d{6})$");
