...
public interface UsuarioRepository extends JpaRepository<Usuario, UUID> {
    ...
    @Query("SELECT p.usuario " + "FROM Persona p "
    ...
    Optional<Usuario> findByCedulaOrPasaporteOrCorreo(
            @Param("cedula") String cedula, @Param("pasaporte") String pasaporte, @Param("correo") String correo);

    @Query("SELECT f.usuario FROM Fabricante f " + "LEFT JOIN Entidad e ON f.id = e.id "
