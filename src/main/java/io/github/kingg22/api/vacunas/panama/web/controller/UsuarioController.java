...
public class UsuarioController {
    ...
    @PostMapping({"/login"})
    public ResponseEntity<IApiResponse<String, Serializable>> login(
            @RequestBody @Valid LoginDto loginDto, ServletWebRequest request) {
        IApiResponse<String, Serializable> apiResponse = apiResponseFactory.createResponse();
    ...
    public ResponseEntity<IApiResponse<String, Serializable>> restore(
            @RequestBody @Valid RestoreDto restoreDto, ServletWebRequest request) {
        IApiResponse<String, Serializable> apiResponse = apiResponseFactory.createResponse();
    ...
    @GetMapping
    public ResponseEntity<IApiResponse<String, Serializable>> profile(
            Authentication authentication, ServletWebRequest request) {
        IApiResponse<String, Serializable> apiResponse = apiResponseFactory.createResponse();
