...
public record UsuarioDto(
        ...
        @JsonProperty(value = "last_used") LocalDateTime lastUsed,
        @NotEmpty(message = "Los roles no puede estar vacíos") @Valid Set<RolDto> roles)
        implements Serializable {
    @Override
    public String toString() {
        return getClass().getSimpleName() + "(" + "id: " + id + ", username: "
                + username + ", createdAt: " + createdAt + ", updatedAt: " + updatedAt + ", lastUsed: " + lastUsed
                + ", roles: ["
                + roles.toString() + "])";
    }
}
